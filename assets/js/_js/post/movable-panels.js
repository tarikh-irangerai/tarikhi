...
(function () {
  ...
  function touchEventToMouseEventInit(panel) {
    ...
    panel.addEventListener("touchstart", touchEventToMouseEvent, {passive: true});
    panel.addEventListener("touchmove", touchEventToMouseEvent, {passive: true});
    panel.addEventListener("touchend", touchEventToMouseEvent, {passive: true});
    panel.addEventListener("touchcancel", touchEventToMouseEvent, {passive: true});
  }
  ...
  function movablePanelsInit() {
    ...
    panel_list.forEach(function (panel) {
      ...
      panel.addEventListener('touchmove', {passive: true}, function (e) {
        e.preventDefault();
      });
  ...
  document.addEventListener("DOMContentLoaded", {passive: true}, movablePanelsInit);

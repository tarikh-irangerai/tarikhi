...
(function () {
  ...
  topNavToggleElement.addEventListener('click', ToggleShowHide, {passive: true});

  /* if outside of side nav is clicked, close it */
  window.addEventListener('click', {passive: true}, function(e) {
  ...
  /* close button event */
  if (closeButton) {
    closeButton.addEventListener('click', {passive: true}, ToggleShowHide);
  }

  /* if window is resized, close side nav */
  window.addEventListener('resize', {passive: true}, function(e) {
